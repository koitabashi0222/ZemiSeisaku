...
public class MeshCutNeo : MonoBehaviour
{
    ...
    public void Cut(Plane cutPlane)
    {
        ...
        GameObject obj = new GameObject("cut obj", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(MeshCutNeo));
        var mesh = new Mesh();
        ...
        obj.GetComponent<MeshCutNeo>().skinWidth = skinWidth;

        GameObject obj2 = new GameObject("cut obj", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(MeshCutNeo));
        var mesh2 = new Mesh();
        ...
        obj2.GetComponent<MeshCutNeo>().skinWidth = skinWidth;
